...
import com.chamud.cheziandsima.mysaytake4.Adapters.UserBillRowAdapter;
 ...
 */
public class UserBillFragment extends ListFragment {
    ...
    ArrayList<UserBill> arrayOfBills;
...
//        }
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        UserBill currentBill = arrayOfBills.get(position);
...

    {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            UserBillRowAdapter adapter = new UserBillRowAdapter(getActivity().getApplicationContext(), arrayOfBills);
        ...
        protected Void doInBackground(Void... urls) {
            ...
            try {
                arrayOfBills = BL.getInstance().getAllUserBills();
